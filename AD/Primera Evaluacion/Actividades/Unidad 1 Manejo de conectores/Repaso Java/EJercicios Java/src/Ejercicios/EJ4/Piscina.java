...
public class Piscina {
    ...
    private int calcularAforo() {
        int aforo_temp = 0;
        int sup_vaso = calcularSupercie(ancho_vaso, long_vaso);

        int sup_parcela = calcularSupercie(ancho_parcela, long_parcela);
    ...
    private int calcularSupercie(int anchura, int longitud) {
