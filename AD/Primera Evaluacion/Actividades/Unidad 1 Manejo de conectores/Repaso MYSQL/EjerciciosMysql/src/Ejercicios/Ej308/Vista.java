...
public class Vista extends javax.swing.JFrame {
    ...
    public String[] getDatos() {
        return new String[] {idTextField.getText(),
                nameTextField.getText(),
                surnameTextField.getText(),
                ageTextField.getText()};
    }

    public void actualizarDatos(ArrayList<Student> listaEstudiantes) {
        String [] listaAlumnos = {"ID", "Name", "Surname", "Age"};
        DefaultTableModel model = new DefaultTableModel(listaAlumnos, 0);

        for (Student s : listaEstudiantes) {
            model.addRow(new Object[] {s.getId(), s.getName(), s.getSurname(), s.getAge()});
        }
